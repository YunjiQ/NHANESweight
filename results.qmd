...
## Scatter plot with Contour line - Weight and height distribution by gender
...
## Scatterplot combining prev_bmi and curr_bmi
...
ggplot(whq, aes(x = curr_bmi, y = race, fill = race)) + 
  ...
  labs(title="BMI Distribution among Race",x="Race", y = "BMI") +
